  ...
  useEffect(() => {
    ...
    const saveUserInfo = async () => {
      ...
      try {
        ...
        // Use the username from Clerk if available, otherwise construct one
        const finalUsername = username || (firstName && lastName ? `${firstName} ${lastName}` : firstName || lastName || email.split('@')[0])
